...
% \SetWatermarkText{\, version:\\{\datestyle\today}\\\, at {\currenttime}}
...
\date{\small This version: 9 June 2022}
...
\hspace{1pt}\vfill
\noindent
Copyright \copyright{} 2022 Carl Martin Ludvig Sinander.
...
and to Catharina Behrens, Josh le Cornu, Tanxin Gao, Sanjari Kalantri, Marie Kaul, Arvo Munoz Moran, Filip Tokarski and Yidan Xu for reporting errors.
...
% the envelope theorem \parencite{MilgromSegal2002,Sinander2021};
...
\chaptermark{Allocating among several agents}
\label{ch2}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
...
% random mechanisms \parencite{GuoShmaya2021};
