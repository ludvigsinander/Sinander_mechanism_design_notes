...
We could just as well replace this lifetime budget constraint with a dynamic budget constraint: the agent starts out with $M_0 \coloneqq (1-\delta) \delta^{-1} K$ `tokens',
